        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.caipinName" type="text" name="caipinName" id="caipinName" placeholder="菜品名称" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div v-if="detail.caipinPhoto" class="layui-input-block">
                    <img id="caipinPhotoImg"
                         style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;"
                         :src="detail.caipinPhoto">
                    <input type="hidden" :value="detail.caipinPhoto" id="caipinPhoto" name="caipinPhoto"/>
                </div>
                <div class="layui-input-block">
                    <button type="button" class="layui-btn btn-theme" id="caipinPhotoUpload">
                        <i class="layui-icon">&#xe67c;</i>上传菜品缩略图
                    </button>
                </div>
            </div>
    ...
    layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate', 'tinymce'], function () {
       ...
       initializationCaipintypesSelect();
        ...
        form.on('submit(thisSubmit)', function (data) {
            ...
            // 提交数据
            http.requestJson('caipin' + '/add', 'post', data, function (res) {
                layer.msg('提交成功', {
                    time: 2000,
                    icon: 6
                }, function () {
