...
public class CaipinLiuyanView extends CaipinLiuyanEntity implements Serializable {
	...
	public CaipinLiuyanView() {

	}

	public CaipinLiuyanView(CaipinLiuyanEntity caipinLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, caipinLiuyanEntity);
