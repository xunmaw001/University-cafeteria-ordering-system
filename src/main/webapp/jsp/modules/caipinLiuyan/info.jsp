            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">菜品评价登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="caipinName" name="caipinName" class="form-control"
                                                   v-model="ruleForm.caipinName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>菜品缩略图</label>
                                        <img id="caipinPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>菜品单价</label>
                                            <input id="caipinNewMoney" name="caipinNewMoney" class="form-control"
                                                   v-model="ruleForm.caipinNewMoney" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="caipinId" name="caipinId" v-model="ruleForm.caipinId" readonly type="hidden">
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "caipinLiuyan/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.caipinContent != null && ruleForm.caipinContent != 'null' && ruleForm.caipinContent != '') {
            var caipinContentUeditor = UE.getEditor('caipinContentEditor');
                caipinContentUeditor.ready(function () {
                    var mes = '' + ruleForm.caipinContent;
                    caipinContentUeditor.setContent(mes);
                    caipinContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.caipinLiuyanContent != null && ruleForm.caipinLiuyanContent != 'null' && ruleForm.caipinLiuyanContent != '') {
            var caipinLiuyanContentUeditor = UE.getEditor('caipinLiuyanContentEditor');
                caipinLiuyanContentUeditor.ready(function () {
                    var mes = '' + ruleForm.caipinLiuyanContent;
