        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">菜品评价管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">菜品评价管理</li>
                            <li class="breadcrumb-item active">菜品评价列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">菜品评价列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(banjiTypesCell);
                ...
                //留言内容
            var caipinLiuyanContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.caipinLiuyanContent && item.caipinLiuyanContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.caipinLiuyanContent.indexOf('<img');
                var endIndex = item.caipinLiuyanContent.indexOf('>');
                    caipinLiuyanContentCell.innerHTML = item.caipinLiuyanContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.caipinLiuyanContent != null && item.caipinLiuyanContent != "" && item.caipinLiuyanContent.length >= 11) {
                        caipinLiuyanContentCell.innerHTML = item.caipinLiuyanContent.substring(0, 10) + "...";
                } else {
                        caipinLiuyanContentCell.innerHTML = item.caipinLiuyanContent;
                }
            }
            row.appendChild(caipinLiuyanContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("caipinLiuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addcaipinLiuyan", "addcaipinLiuyan");
            window.location.href = "add-or-update.jsp"
        }
