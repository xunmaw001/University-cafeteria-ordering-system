                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>菜品类型</label>
                                        <select id="caipinTypesSelect" name="caipinTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>菜品缩略图</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="caipinNewMoney" name="caipinNewMoney" class="form-control"
                                               onchange="caipinNewMoneyChickValue(this)"  placeholder="菜品单价">
                                    </div>
    ...
    function getContent() {
        ...
        if($("#caipinContentupload").length>0) {
            ...
            if (caipinContentEditor.hasContents()) {
                $('#caipinContent-input').attr('value', caipinContentEditor.getPlainTxt());
            }
        }
    }
    //数字检查
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                caipinPhoto: "菜品缩略图不能为空",
                caipinNewMoney: "菜品单价不能为空",
