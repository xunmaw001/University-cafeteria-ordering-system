        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.gonggaoName" type="text" name="gonggaoName" id="gonggaoName" placeholder="公告名称" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
