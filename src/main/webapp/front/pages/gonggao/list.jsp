                            ...
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../gonggao/detail.jsp?id='+item.id">
                                        ...
                                        <p class="reamk">{{item.gonggaoContent|gonggaoContent}}...</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 gonggaoContent 字段去除无用字符 如果字段长度大于60  就截取到60
            gonggaoContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            var gonggaoTypes = $("#gonggaoTypes").find("option:selected").val();
            if (gonggaoTypes != null && gonggaoTypes != "" && gonggaoTypes != "null") {
                param['gonggaoTypes'] = gonggaoTypes;
            }
                            // 获取列表数据
