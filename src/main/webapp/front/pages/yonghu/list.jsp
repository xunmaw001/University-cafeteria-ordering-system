                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuNumber" id="yonghuNumber" placeholder="学号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#yonghuNumber').val() != null && jquery('#yonghuNumber').val() != "" && jquery('#yonghuNumber').val() != "null" ) {
                param['yonghuNumber'] = jquery('#yonghuNumber').val();
            }
