            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <td style="width: 50px;">{{item.caipinId}}</td>
                        ...
                        <td style="width: 150px;">{{item.caipinQucanTime}}</td>
                            <!--<td style="width: 100px;">
                                <button v-if="item.status=='未支付'" @click="pay(item)" type="button"
                                        class="layui-btn layui-btn-sm layui-btn-radius btn-theme">
                                    <i class="layui-icon">&#xe65e;</i> 支付
                                </button>
                                <button v-if="item.status=='已支付'" @click="refund(item)" type="button"
                                        class="layui-btn layui-btn-sm layui-btn-radius layui-btn-warm">
                                    <i class="layui-icon">&#xe65e;</i> 退款
                                </button>
                                <button v-if="item.status=='已发货'" @click="confirm(item)" type="button"
                                        class="layui-btn layui-btn-sm layui-btn-radius layui-bg-green">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 caipinOrderContent 字段去除无用字符 如果字段长度大于60  就截取到60
            caipinOrderContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                // 获取列表数据
            http.request('caipinOrder/list', 'get', param, function(res) {
